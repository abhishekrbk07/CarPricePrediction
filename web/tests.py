...
class PriceTest(StaticLiveServerTestCase):
    ...
    def test_price(self):
        ...
        time.sleep(1)
        alert = selenium.switch_to.alert
        # self.assertEqual("Your Price has been booked!", alert.text)
        time.sleep(1)
        td = Price.objects.get(user=self.user)
        self.assertEqual(td.__str__(), "Test User - Name")
